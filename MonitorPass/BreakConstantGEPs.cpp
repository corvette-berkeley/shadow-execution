...
static RegisterPass<BreakConstantGEPs> P("break-constgeps", "Remove GEP Constant Expressions");
...
static Instruction* convertGEP(ConstantExpr* CE, Instruction* InsertPt) {
	...
	//
	return GetElementPtrInst::Create(CE->getOperand(0), Indices, CE->getName(), InsertPt);
}
