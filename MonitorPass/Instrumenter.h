...
void KVALUE_STRUCTVALUE(Value* value, InstrPtrVector& instrs) {
  ...
  /*******************************************************************************************/
  Instruction* CALL_IID_KIND_INT_INT_INT64_BOOL_INT_INT(const char* func, Value* iid, Value* kind, Value *scope, Value *opInx, Value *opAddr, Value* loadGlobal,  
  ...
  /*******************************************************************************************/
  Instruction* CALL_INT_INT_KIND_INT_INT_INT64_INT_INT_INT(const char* func, Value *i32_0, Value *i32_1, Value* kind, Value *scope, Value *srcInx, Value *i64_1, Value *i32_2, Value *i32_3, Value *i32_4) {
    TypePtrVector ArgTypes;
    ArgTypes.push_back(INT32_TYPE());
    ArgTypes.push_back(INT32_TYPE());
    ArgTypes.push_back(KIND_TYPE());
  ...
  /*******************************************************************************************/
  Instruction* CALL_INT_INT_INT64_INT64_KIND_INT(const char* func, Value *i32_1, Value *i32_2, Value *i64_1, Value *i64_2, 
  ...
  /*******************************************************************************************/
  Instruction* CALL_IID_BOOL_BOOL_KVALUE_KVALUE_INT_INT(const char* func, Value* iid, Value* b1, Value* b2, Value* kvalue1, Value* kvalue2, Value* line, Value* inx) {
    TypePtrVector ArgTypes;
    ArgTypes.push_back(IID_TYPE());
    ArgTypes.push_back(BOOL_TYPE());
    ArgTypes.push_back(BOOL_TYPE());
