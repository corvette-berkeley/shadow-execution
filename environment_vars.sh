...
export FPPASS_LIB_PATH="$INSTRUMENTOR_PATH""/FPPass"
...
export LD_LIBRARY_PATH="$INSTRUMENTOR_LIB_PATH/:$GPERFTOOLS_LIB_PATH/:$GLOG_LIB_PATH/:$UNWIND_LIB_PATH/:$MONITOR_LIB_PATH/:$BLAMEANALYSIS_LIB_PATH/:$FPPASS_LIB_PATH/:$LD_LIBRARY_PATH"
