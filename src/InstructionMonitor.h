...
extern "C" {
  ...
  void llvm_allocax(IID iid, KIND kind, uint64_t size, int x, bool arg);
  void llvm_allocax_array(IID iid, KIND kind, uint64_t size, int x, bool arg);
  void llvm_allocax_struct(IID iid, uint64_t size, int x, bool arg);
