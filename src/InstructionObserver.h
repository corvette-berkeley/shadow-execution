...
public:
	...
	virtual void allocax(IID iid UNUSED, KIND kind UNUSED, int inx UNUSED) {};
	virtual void load(IID iid UNUSED, PTR addr UNUSED, IID addr_iid UNUSED, KVALUE* value UNUSED, int inx UNUSED) {};
	virtual void store(IID iid UNUSED, PTR addr UNUSED, IID addr_iid UNUSED, KVALUE* value UNUSED, int inx UNUSED) {};
	virtual void fence() {};
	...
	virtual void getelementptr(IID iid UNUSED, bool inbound UNUSED, KVALUE* value UNUSED, int inx UNUSED) {};
	...
	virtual void call(IID iid UNUSED, KVALUE* value UNUSED, int inx UNUSED) {};
	virtual void vaarg() {};
