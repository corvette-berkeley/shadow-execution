...
BlameNode
BlameTree::constructFuncBlameNode(BlameTreeShadowObject<HIGHPRECISION>
...
BlameNode BlameTree::constructBlameNode(BlameTreeShadowObject<HIGHPRECISION>
...
BlameNode BlameTree::constructBlameGraph(vector<vector<
                BlameTreeShadowObject<HIGHPRECISION> > > trace) {
