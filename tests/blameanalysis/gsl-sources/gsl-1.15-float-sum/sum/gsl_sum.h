...
int gsl_sum_levin_u_accel(const double* array, const size_t n, gsl_sum_levin_u_workspace* w, double* sum_accel,
						  float* abserr);
...
int gsl_sum_levin_u_minmax(const double* array, const size_t n, const size_t min_terms, const size_t max_terms,
						   gsl_sum_levin_u_workspace* w, double* sum_accel, float* abserr);
...
int gsl_sum_levin_u_step(const double term, const size_t n, const size_t nmax, gsl_sum_levin_u_workspace* w,
						 double* sum_accel);
...
int gsl_sum_levin_utrunc_accel(const float* array, const size_t n, gsl_sum_levin_utrunc_workspace* w, float* sum_accel,
							   float* abserr_trunc);

int gsl_sum_levin_utrunc_minmax(const float* array, const size_t n, const size_t min_terms, const size_t max_terms,
								gsl_sum_levin_utrunc_workspace* w, float* sum_accel, float* abserr_trunc);

int gsl_sum_levin_utrunc_step(const float term, const size_t n, gsl_sum_levin_utrunc_workspace* w, float* sum_accel);
