...
int
gsl_sum_levin_utrunc_accel (const float *array,
                            const size_t array_size,
                            gsl_sum_levin_utrunc_workspace * w,
                            float *sum_accel, float *abserr_trunc)
{
...
int
gsl_sum_levin_utrunc_minmax (const float *array,
                             const size_t array_size,
                             ...
                             float *sum_accel, float *abserr_trunc)
{
  if (array_size == 0)
  ...
  else
    {
      ...
      float trunc_n = 0.0, trunc_nm1 = 0.0;
      float actual_trunc_n = 0.0, actual_trunc_nm1 = 0.0;
      float result_n = 0.0, result_nm1 = 0.0;
      size_t n;
      int better = 0;
      int before = 0;
      int converging = 0;
      float least_trunc = GSL_DBL_MAX;
      float result_least_trunc;
...
int
gsl_sum_levin_utrunc_step (const float term,
                           const size_t n,
                           gsl_sum_levin_utrunc_workspace * w, float *sum_accel)
{
  if (term == 0.0)
    {
