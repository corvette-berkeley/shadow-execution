...
void check_trunc (float * t, float expected, const char * desc);
void check_full (float * t, float expected, const char * desc);
...
main (void)
{
...

  {
    ...
    const float zeta_2 = M_PI * M_PI / 6.0;
...

  {
    ...
    float result = 0.5772156649015328606065120900824; 
...

  {
    ...
    float result = 0.6048986434216305;  /* approx */
...
void
check_trunc (float * t, float expected, const char * desc)
{
  float sum_accel, prec;
...
void
check_full (float * t, float expected, const char * desc)
{
  float sum_accel, err_est, sd_actual, sd_est;
