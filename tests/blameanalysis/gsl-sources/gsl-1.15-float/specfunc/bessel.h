 ...
 *   sign = +1  ==> Inu
 */
int gsl_sf_bessel_IJ_taylor_e(const double nu, const double x, const int sign, const int kmax, const double threshold,
 ...
 * sgn   = sgn(J_nu(x))
 */
int gsl_sf_bessel_J_CF1(const double nu, const double x, double* ratio, double* sgn);
 ...
 * (J' + i Y')/(J + i Y) := P + i Q
 */
int gsl_sf_bessel_JY_steed_CF2(const double nu, const double x, double* P, double* Q);


int gsl_sf_bessel_JY_mu_restricted(const double mu, const double x, gsl_sf_result* Jmu, gsl_sf_result* Jmup1,
								   gsl_sf_result* Ymu, gsl_sf_result* Ymup1);


int gsl_sf_bessel_K_scaled_steed_temme_CF2(const double nu, const double x, double* K_nu, double* K_nup1,
		double* Kp_nu);
 ...
 *   sin(y - pi/4 + eps)
 */
int gsl_sf_bessel_cos_pi4_e(float y, float eps, gsl_sf_result* result);
