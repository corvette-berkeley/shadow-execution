...
static int falsepos_init (void * vstate, gsl_function * f, float * root, float x_lower, float x_upper);
static int falsepos_iterate (void * vstate, gsl_function * f, float * root, float * x_lower, float * x_upper);

static int
falsepos_init (void * vstate, gsl_function * f, float * root, float x_lower, float x_upper)
{
...
static int
falsepos_iterate (void * vstate, gsl_function * f, float * root, float * x_lower, float * x_upper)
{
  falsepos_state_t * state = (falsepos_state_t *) vstate;

  float x_linear, f_linear;
  float x_bisect, f_bisect;

  float x_left = *x_lower ;
  float x_right = *x_upper ;

  float f_lower = state->f_lower; 
  float f_upper = state->f_upper;
