...
float gsl_cdf_gaussian_P(const float x, const float sigma);
float gsl_cdf_gaussian_Q(const float x, const float sigma);

float gsl_cdf_gaussian_Pinv(const float P, const float sigma);
float gsl_cdf_gaussian_Qinv(const float Q, const float sigma);
...
double gsl_cdf_hypergeometric_P(const unsigned int k, const unsigned int n1, const unsigned int n2,
								const unsigned int t);
double gsl_cdf_hypergeometric_Q(const unsigned int k, const unsigned int n1, const unsigned int n2,
								const unsigned int t);
