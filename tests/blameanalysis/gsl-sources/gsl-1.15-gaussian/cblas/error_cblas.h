...
#define CHECK_ARGS_X(FUNCTION, VAR, ARGS)                                                                              \
	do {                                                                                                                 \
		...
		if (VAR) cblas_xerbla(pos, __FILE__, "");                                                                          \
	} while (0)

#define CHECK_ARGS7(FUNCTION, A1, A2, A3, A4, A5, A6, A7) CHECK_ARGS_X(FUNCTION, pos, (pos, A1, A2, A3, A4, A5, A6, A7))
