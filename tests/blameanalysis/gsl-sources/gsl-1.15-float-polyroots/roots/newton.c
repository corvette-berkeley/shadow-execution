...
static int newton_init (void * vstate, gsl_function_fdf * fdf, float * root);
static int newton_iterate (void * vstate, gsl_function_fdf * fdf, float * root);

static int
newton_init (void * vstate, gsl_function_fdf * fdf, float * root)
{
...
static int
newton_iterate (void * vstate, gsl_function_fdf * fdf, float * root)
{
  newton_state_t * state = (newton_state_t *) vstate;
  
  float root_new, f_new, df_new;
