...
int test_sf_e10(gsl_sf_result_e10 r, double val_in, int e10_in, double tol, int status, int expect_return,
				const char* desc);
...
int test_sf_2(gsl_sf_result r1, double val1, double tol1, gsl_sf_result r2, double val2, double tol2, int status,
...
#define TEST_SF_E10(stat, func, args, val_in, e10_in, tol, expect_return)                                              \
	{                                                                                                                    \
		int status = func args;                                                                                            \
		stat += test_sf_e10(re, val_in, e10_in, tol, status, expect_return, #func #args);                                  \
	}
...
#define TEST_SF_2(stat, func, args, val1, tol1, val2, tol2, expect_return)                                             \
	{                                                                                                                    \
		int status = func args;                                                                                            \
		stat += test_sf_2(r1, val1, tol1, r2, val2, tol2, status, expect_return, #func #args);                             \
	}

#define TEST_SF_SGN(stat, func, args, val_in, tol, expect_sgn, expect_return)                                          \
	{                                                                                                                    \
		int status = func args;                                                                                            \
		stat += test_sf_sgn(r, sgn, val_in, tol, expect_sgn, status, expect_return, #func #args);                          \
	}
