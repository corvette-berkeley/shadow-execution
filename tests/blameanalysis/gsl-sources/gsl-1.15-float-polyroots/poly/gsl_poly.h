...
INLINE_DECL double gsl_poly_dd_eval(const double dd[], const double xa[], const size_t size, const double x);
...
int gsl_poly_complex_solve(const double* a, size_t n, gsl_poly_complex_workspace* w, float* z);
