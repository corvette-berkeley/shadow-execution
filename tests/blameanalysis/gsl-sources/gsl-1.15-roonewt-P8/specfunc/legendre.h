 ...
 * |x| < 1
 */
int gsl_sf_conicalP_xlt1_large_neg_mu_e(double mu, double tau, double x, gsl_sf_result* result, double* ln_multiplier);
 ...
 * 1 < x
 */
int gsl_sf_conicalP_xgt1_neg_mu_largetau_e(const double mu, const double tau, const double x, double acosh_x,
 ...
 * -1 < x < 1
 */
int gsl_sf_conicalP_xlt1_neg_mu_largetau_e(const double mu, const double tau, const double x, const double acos_x,
		gsl_sf_result* result, double* ln_multiplier);
 ...
 */
int gsl_sf_conicalP_large_x_e(const double mu, const double tau, const double x, gsl_sf_result* result,
