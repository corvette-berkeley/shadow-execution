...
static int steffenson_init (void * vstate, gsl_function_fdf * fdf, float * root);
static int steffenson_iterate (void * vstate, gsl_function_fdf * fdf, float * root);

static int
steffenson_init (void * vstate, gsl_function_fdf * fdf, float * root)
{
...
static int
steffenson_iterate (void * vstate, gsl_function_fdf * fdf, float * root)
{
  steffenson_state_t * state = (steffenson_state_t *) vstate;
