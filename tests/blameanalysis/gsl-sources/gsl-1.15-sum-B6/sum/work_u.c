...
gsl_sum_levin_u_alloc (size_t n)
{
  ...
  w->q_num = (float *) malloc (n * sizeof (float));
  ...
  w->q_den = (float *) malloc (n * sizeof (float));
  ...
  w->dq_num = (float *) malloc (n * n * sizeof (float));
  ...
  w->dq_den = (float *) malloc (n * n * sizeof (float));
  ...
  w->dsum = (float *) malloc (n * sizeof (float));
