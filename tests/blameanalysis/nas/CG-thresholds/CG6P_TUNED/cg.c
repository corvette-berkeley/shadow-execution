...
static void vecset(int n, double v[], int iv[], int *nzv, int i, float val);
//---------------------------------------------------------------------
...
int main(int argc, char *argv[])
{
  ...
  float zeta;
  float rnorm;
  float norm_temp1, norm_temp2;

  double t, mflops, tmax; // removed from search space
  char Class;
  logical verified;
