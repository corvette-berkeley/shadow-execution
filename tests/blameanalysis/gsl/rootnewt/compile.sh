...
llvm-link -o $2/$1.bc $2/temp_$1.bc $2/timers.bc $2/cov_checker.bc $2/cov_serializer.bc $2/cov_log.bc $2/cov_rand.bc $2/demo_fn.bc $GSL_PATH/libgsl-3.4.so.bc $GSL_PATH/libgslcblas-3.4.so.bc
